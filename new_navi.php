    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
           ...
           <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">QUT Music school</a>
            </div>
 ...
 <b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="index.html"><i class="fa fa-fw fa-dashboard"></i> main 1</a>
                    </li>
                   
                    <li>
                        <a href="index.html"><i class="fa fa-fw fa-table"></i> main 2</a>
                    </li>
                    <li>
                        <a href="index.html"><i class="fa fa-fw fa-edit"></i> main 3</a>
                    </li>
                    <li>
                        <a href="index.html"><i class="fa fa-fw fa-desktop"></i> main 3</a>
                    </li>
                    <li>
                        <a href="index.html"><i class="fa fa-fw fa-wrench"></i> main 4</a>
                    </li>
                    <li>
