...
<!-- 
 ...
 -->
	  <a class="navbar-brand" href="http://localhost:133/musicschool/index.php">QUT Music School</a>
	 </div>
	  <div class="collapse navbar-collapse" id="myNavbar">
		  <ul class="nav navbar-nav navbar-right">
			  <li><a href="http://localhost:133/musicschool/index.php">HOME</a></li>
			  <li><a href="#newsfeed">News</a></li>
			  <li><a href="http://localhost:133/musicschool/pages/lesson.php">Lesson</a></li>
