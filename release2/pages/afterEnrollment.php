...
?>
  ...
  $checkBoxArr=giveArrayName($rowNum); //Making names like checkBox0,checkBox1....
   ?>
...
<script type="text/javascript">
 ...
 function check(val,val2,val3){
   lessonTimeID = val ;
   //alert('this is '+lessonTimeID);
   var checkBoxId = val2 ; // this value includes names to represent checkBoxes
   var count=val3;
   //alert('this is '+count);
 ...
 function finalClick(val){
   alert('this is '+chosenIndex);
   if (confirm('Are you sure you want to submit this?')){
     $.ajax({
        url:'finalSubmit_enrollment.php',
        type:'post',
        data: {chosenCheckBoxArr:chosenCheckBoxArr,userName:userName,chosenIndex:chosenIndex,lessonID:lessonID},
        dataType:'json',
        async: false,
        success:function(data){
          //alert('this is '+data[1][0]);
        }
      });
