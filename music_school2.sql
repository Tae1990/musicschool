...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 10, 2016 at 10:35 AM
...
(3, 'Axiom Student Flute', '../images/flute.jpg', 'on', 'excellent', '50');
...
(4, 'Cason', 'Canales', '1992-02-07', 'Seoul', 'F', 431481232, 431481232, 'angel1004@gmail.com', 'angel1004@gmail.com', 9, 'new'),
...
--
ALTER TABLE `contracts`
  MODIFY `studentContractID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `hiredinstruments`
--
ALTER TABLE `hiredinstruments`
  MODIFY `hiredInstrumentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
